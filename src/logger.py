...
class Logger():
    ...
    def dump_to_wandb(self):
        # https://pytorch-lightning.readthedocs.io/en/stable/extensions/generated/lightning.pytorch.loggers.WandbLogger.html#lightning.pytorch.loggers.WandbLogger.experiment
